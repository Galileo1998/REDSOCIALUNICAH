...
export class LoginComponent extends Component<ILoginComponentProps, ILoginComponentState> {
  ...
  handleForm = () => {
    ...
    if (this.state.emailInput.indexOf('@unicah.edu') < 0) {
      this.setState({
        emailInputError: translate!('login.unicahdomain')
      })
      error = true
    }
    if (!error) {
  ...
  handleFormAnonimous = () => {
    ...
    let error = false
      ...
      this.props.login!(
        'anonimousanonimo2020@gmail.com',
        'anonimo'
      )
  ...
  render() {
    ...
    const OAuthLogin = (
      <div style={this.styles.singinOptions as any}>
                    <Background>
                        <ImgCover width='30px' height='50px' borderRadius='2px'
                        fileName={config.settings.logoUnicah} />
                    </Background>
      </div>
    )
              ...
              <form>
                <div style={{ padding: '48px 40px 36px' }}>
                  ...
                  <div className='login__button-box'>
                    ...
                    <div >
                      <Button variant='contained' color='primary' onClick={this.handleFormAnonimous} tabIndex={3} >{translate!('login.anonimous')}</Button>
                    </div>
                  </div>
